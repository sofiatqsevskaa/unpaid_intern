...
class VectorStorage:
    ...
    def create_collection(self, user_id: str):
        ...
        logger.info(f"Creating/getting collection for user {user_id}")
    ...
    def add_document(self, user_id: str, document_name: str, content: str, metadata: Dict[str, Any]):
        logger.info(
            f"Adding document '{document_name}' to vector storage for user {user_id}")
        ...
        logger.info(
            f"Added document '{document_name}' with {len(chunks)} chunks")
